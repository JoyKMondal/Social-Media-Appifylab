    ...
    props.element === "input" ? (
      <div className="relative">
        <input
          ...
          className="input-box"
        />
        {props.id === "firstName" && <i className="fi fi-sr-user input-icon"></i>}
        {props.id === "lastName" && <i className="fi fi-sr-user input-icon"></i>}
        {props.id === "email" && (
          <i className="fi fi-sr-envelope input-icon"></i>
        )}
        {props.id === "password" && <i className="fi fi-sr-key input-icon"></i>}
        {props.id === "repeatPassword" && <i className="fi fi-sr-key input-icon"></i>}
      </div>
    ) : (
      <textarea
        id={props.id}
